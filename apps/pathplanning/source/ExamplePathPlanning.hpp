...
/**
 * @brief Get an example parameter set for the path planner.
 * @return Example parameter set.
 */
inline mpsv::planner::PathPlannerParameterSet GetParameterSet(void){
    ...
    // geometry
    parameterSet.geometry.collisionCheckMaxPositionDeviation           = 0.1;
...
/**
 * @brief Get an example input data for the path planner.
 * @return Example input data.
 */
inline mpsv::planner::PathPlannerInput GetInput(void){
