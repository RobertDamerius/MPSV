...
/**
 * @brief Get an example parameter set for the online planner.
 * @return Example parameter set.
 */
inline mpsv::planner::OnlinePlannerParameterSet GetParameterSet(void){
    mpsv::planner::OnlinePlannerParameterSet parameterSet;
...
/**
 * @brief Get an example input data for the online planner.
 * @param[in] timestamp The timestamp to be set for the input data.
 * @return Example input data.
 */
inline mpsv::planner::OnlinePlannerInput GetInput(double timestamp){
    mpsv::planner::OnlinePlannerInput dataIn;
