/**
 * SFunctionMPSVPathPlannerThread.cpp
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         void MPSV_PathPlannerThreadStep(void* work1, uint8 y1[6142], uint8 u1[1073610])
 *
 *    Simulink version           : 23.2 (R2023b) 01-Aug-2023
 *    C++ source code generated on : 28-Mar-2024 16:11:58
 *
...
/**
     ...
     def.SFunctionName = 'SFunctionMPSVPathPlannerThread';
     def.OutputFcnSpec = 'void MPSV_PathPlannerThreadStep(void* work1, uint8 y1[6142], uint8 u1[1073610])';
     def.StartFcnSpec = 'void MPSV_PathPlannerThreadInitialize(void** work1, int16 p1, uint32 p2, int32 p3)';
     def.TerminateFcnSpec = 'void MPSV_PathPlannerThreadTerminate(void* work1)';
     def.HeaderFiles = {'MPSV_DriverPathPlannerThread.hpp'};
     def.SourceFiles = {'MPSV_DriverPathPlannerThread.cpp', 'MPSV_WrapperPathPlannerThread.cpp'};
     def.IncPaths = {'code'};
     def.SrcPaths = {'code'};
...
#define S_FUNCTION_NAME  SFunctionMPSVPathPlannerThread
...
#include "MPSV_DriverPathPlannerThread.hpp"
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "MPSV_PathPlannerThreadInitialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "MPSV_PathPlannerThreadStep", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "MPSV_PathPlannerThreadTerminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for wrappers */
        if (ssRTWGenIsModelReferenceSimTarget(S)) {

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "MPSV_PathPlannerThreadInitialize_wrapper_Start", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "MPSV_PathPlannerThreadStep_wrapper_Output", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

            /* Register reserved identifier for  */
            ssRegMdlInfo(S, "MPSV_PathPlannerThreadTerminate_wrapper_Terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
        } /* if */
    } /* if */
...
static void mdlStart(SimStruct *S)
{
    ...
    MPSV_PathPlannerThreadInitialize(&work1, *p1, *p2, *p3);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call the legacy code function */
    MPSV_PathPlannerThreadStep(work1, y1, u1);
...
static void mdlTerminate(SimStruct *S)
{
    ...
    /* Call the legacy code function */
    MPSV_PathPlannerThreadTerminate(work1);
