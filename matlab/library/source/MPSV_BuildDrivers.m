...
def.OutputFcnSpec           = 'void MPSV_PathPlannerStep(void* work1, uint8 y1[24023], uint8 u1[324550])';
...
def.OutputFcnSpec           = 'void MPSV_AsynchronousOnlinePlannerStep(void* work1, uint8 y1[144128], uint8 u1[321196], uint8 u2[4473])';
