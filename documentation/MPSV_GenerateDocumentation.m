...
layoutNavBar = [
    ...
    SimpleDoc.NavEntry(SimpleDoc.NavEntryType.link, 'AutoTune AsyncOnlinePlanner', 'library_autotuneasynconlineplanner.html');
...
SimpleDoc.Make(title, inputDirectory, outputDirectory, layoutNavBar, false, ['Version ', char(strjoin(string(mpsv.GetVersion()),'.'))]);
